...
var Coverflow =
{
	...
	init: function(list, o)
	{
		...
		this.container = CVFL$('coverflow');
		this.container.className = 'loading';
		this.wrapper = CVFL$('coverflow-wrapper');
		this.wrapperAnim = new Anim(this.wrapper);
		this.label = CVFL$('coverflow-label');
	...
	setup: function(list)
	{
		...
		var k = 3;
		var start = (sel >= k) ? sel - k : 0;
		var end = (sel >= k) ? start + 2*k + 1 : sel + k + 1;
